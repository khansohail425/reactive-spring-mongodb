...
class MovieInfoControllerUnitTest {
    ...
    void testGetMovieById() {
        ...
        when(moviesInfoService.getMovieById(eq("abc"))).thenReturn(Mono.just(new MovieInfo("abc", "Dark Knight Rises",
                2012, List.of("Christian Bale", "Tom Hardy"), LocalDate.parse("2012-07-20"))));
    ...
    void testUpdateMovieInfo() {
        ...
        when(moviesInfoService.updateMovieInfo(isA(String.class), eq(requestBody))).thenReturn(Mono.just(requestBody));
